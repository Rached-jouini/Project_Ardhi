...
public final class EnvLoader {
    ...
    private static java.util.Map<String, String> loadDotEnv() {
        ...
        try (java.io.BufferedReader reader = java.nio.file.Files.newBufferedReader(envPath, java.nio.charset.StandardCharsets.UTF_8)) {
            String line;
    ...
    private static void parseLine(String line, java.util.Map<String, String> values) {
